...
type BaseSpinalCordHandle struct {
    ...
    mgr *handler.HandlersManager
}
func NewBaseSpinalCordHandle(mgr *handler.HandlersManager) BaseSpinalCordHandle {
...
func NewNamespaceHandle(mgr *handler.HandlersManager) *NamespaceHandle {
...
func NewEventTypeHandle(mgr *handler.HandlersManager) *EventTypeHandle {
...
func NewEventTypeHandlersHandle(mgr *handler.HandlersManager) *EventTypeHandlersHandle {
...
func NewEventHandlerHandle(mgr *handler.HandlersManager) *EventHandlerHandle {
...
func (n *EventHandlerHandle) writeHandlerToFile(iRequestPath string, data string, overwrite bool) map[string]string {
    ihandler, err := handler.NewHandler(iRequestPath, []byte(data))
    if err != nil {
